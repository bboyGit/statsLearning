        ...
        if K == 1:
            ...
            if info_gain_max < thresh:
                ...
                for val in feature:
                    ...
                    result[(curr_node_name, val)] = data_i, self.generate(data_i, thresh, response, method)
                return result

    def root(self, dt):
        dt1 = {}
        dt1['Root'] = self.data, dt
        return dt1
...
if __name__ == "__main__":
    ...
    id3 = dt.generate(train, thresh=0.001, response='cancer', method='id3')
    id3 = dt.root(id3)
    dt.print_tree(id3, ' ')
